...
from rusentrel.classic.mi.cnn import mi_cnn_custom_config
...
def run_testing_mi_cnn(
    ...
    run_testing(full_model_name=name_prefix + model_names_classtype().CNN,
                ...
                custom_config_modification_func=mi_cnn_custom_config,
