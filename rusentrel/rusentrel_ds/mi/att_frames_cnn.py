...
from rusentrel.classic.mi.att_frames_cnn import mi_att_frames_cnn_config
...
def run_testing_mi_att_frames_cnn(
    ...
    run_testing(full_model_name=name_prefix + model_names_classtype().AttFramesCNN,
                ...
                custom_config_modification_func=mi_att_frames_cnn_config,
