...
from rusentrel.classic.mi.att_bilstm import mi_att_bilstm_custom_config
...
def run_testing_mi_att_bilstm(
    ...
    run_testing(full_model_name=name_prefix + model_names_classtype().AttSelfPZhouBiLSTM,
                ...
                custom_config_modification_func=mi_att_bilstm_custom_config,
