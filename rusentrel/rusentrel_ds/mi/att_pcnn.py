...
from rusentrel.classic.mi.att_pcnn import mi_att_pcnn_custom_config
...
def run_testing_mi_att_pcnn(
    ...
    run_testing(full_model_name=name_prefix + model_names_classtype().AttEndsPCNN,
                create_network=lambda: network_classtype(context_network=AttentionEndsPCNN()),
                create_config=lambda: config_classtype(context_config=AttentionEndsPCNNConfig()),
                ...
                custom_config_modification_func=mi_att_pcnn_custom_config,
                common_config_modification_func=ds_mi_common_config_settings)


if __name__ == "__main__":

    run_testing_mi_att_pcnn()
