...
from rusentrel.classic.mi.self_att_bilstm import mi_self_att_bilstm_custom_config
...
def run_testing_mi_self_att_bilstm(
    ...
    run_testing(full_model_name=name_prefix + model_names_classtype().SelfAttentionBiLSTM,
