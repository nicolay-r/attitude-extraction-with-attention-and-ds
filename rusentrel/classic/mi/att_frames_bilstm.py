...
def mi_att_frames_bilstm_custom_config(config):
    ctx_att_frames_bilstm_custom_config(config.ContextConfig)
...
def run_testing_att_frames_bilstm(name_prefix=u'',
                                  ...
                                  custom_config_func=mi_att_frames_bilstm_custom_config,
