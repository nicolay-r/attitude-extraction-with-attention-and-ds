...
from rusentrel.classic.ctx.att_cnn import ctx_att_cnn_custom_config
from rusentrel.classic.common import \
    classic_common_callback_modification_func, \
    classic_mi_common_config_settings


def mi_att_cnn_custom_config(config):
    ctx_att_cnn_custom_config(config.ContextConfig)
...
def run_testing_att_cnn(name_prefix=u'',
                        ...
                        custom_config_func=mi_att_cnn_custom_config,
